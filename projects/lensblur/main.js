...
//display the emailadress
    ...
    function plot_update(is_slider)
    {
        ...
        console.log($("#graph"));
        console.log( read_form(is_slider));
    ...
    {
        $("#after_inputs").before('<p class="input_line"><abbr title="Leave at 1 for full frame goodness, or take your pick.">Crop Factor</abbr>: <input type="text" class="crop" value="'+crop+'" style="width:50px;" /> with a lens at: <input class="mm" type="text" value="'+mm+'" style="width:60px;" /> mm @ F/ <input type="text" value="'+f+'" class="f" style="width:50px;" /><a class="remove" style="float:right">Remove</a></p>');
    }
    ...
    function read_form(is_slider)
    {
        ...
        var url;
        var hash;
        url="http://asklens.com/howmuchblur/#";
        hash="compare-";
    ...
    $(window).resize(function() {plot_update();});
