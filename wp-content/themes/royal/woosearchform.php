	...
	<form action="<?php echo esc_url( home_url( '/' ) ); ?>" id="searchform" class="hide-input" method="get"> 
		<div class="form-horizontal modal-form">
			<div class="form-group has-border">
				<div class="col-xs-10">
					<input type="text" value="<?php if(get_search_query() == ''){  esc_attr_e('Search for...', 'royal');} else { the_search_query(); } ?>" class="form-control" onblur="if(this.value=='')this.value='<?php _e('Search for...', 'royal'); ?>'" onfocus="if(this.value=='<?php _e('Search for...', 'royal'); ?>')this.value=''" name="s" id="s" />
